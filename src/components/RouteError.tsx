// ─── Sprint 4 #18: shared segment error UI ─────────────────────────────────
// Har segment ka error.tsx yehi render karta hai (reset/retry samet).
// Root error.tsx Sentry capture karta hai; segment boundary par dobara
// capture nahi (double-report se bachne ke liye).
"use client";
