  ...
  return (
    <div className="mb-4 flex items-center gap-3 px-4 py-3 rounded-2xl border border-amber-500/25 bg-amber-500/10 text-[12px] font-bold text-amber-200 anim-fade">
      ...
      <p className="flex-1 min-w-0">
        Ye system <span className="text-amber-300">trial mode</span> mein chal raha hai — license
        activate nahi hua.
        {state.configured === false && (
          <span className="text-amber-500/80"> (license service setup nahi hai)</span>
        )}
      </p>
      <Link
        href="/settings"
