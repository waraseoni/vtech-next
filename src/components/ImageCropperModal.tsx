...
export default function ImageCropperModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex flex-col bg-black/95">
      ...
      {/* Controls */}
      <div className="p-4 bg-[#161b27] border-t border-[#21293d] space-y-3">
        {err && (
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={busy}
            className="px-4 py-2.5 rounded-xl border border-white/10 text-sm text-slate-300 hover:bg-white/5 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
