        ...
        <div className="flex flex-wrap items-center gap-1.5">
          {presets.map((p) => (
            <button
              ...
              className="px-3 py-1.5 bg-[#0d1117] border border-[#21293d] rounded-full text-[11px] font-bold text-slate-400 hover:text-white hover:border-blue-500/40 transition"
            >
              {p.label}
            </button>
          ))}
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-3 py-1.5 bg-[#0d1117] border border-[#21293d] rounded-full text-[11px] font-bold text-slate-400 hover:text-white hover:border-blue-500/40 transition"
          >
