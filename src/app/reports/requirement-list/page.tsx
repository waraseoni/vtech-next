        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {filtered.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="bg-[#161b27] border border-[#21293d] rounded-[2rem] p-5 shadow-2xl hover:border-amber-500/30 transition-all"
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span
                    className={`shrink-0 px-3 py-1 rounded-lg text-[10px] font-black border uppercase tracking-wider ${isOut ? "bg-red-500/15 text-red-300 border-red-500/30" : "bg-orange-500/15 text-orange-300 border-orange-500/30"}`}
                  >
                    {isOut ? (
