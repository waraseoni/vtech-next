    ...
    <div className="space-y-6 max-w-[1600px] mx-auto pb-20">
        ...
        <div className="mt-5 relative">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-[#0d1117] border border-[#21293d] rounded-2xl text-sm text-slate-200 placeholder:text-slate-700 outline-none focus:border-emerald-500/50"
            />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 no-print">
        <div className="bg-[#161b27] border border-[#21293d] rounded-2xl p-4 text-center">
          ...
          <p className="text-lg font-black text-slate-200 mt-1">{inr(totalBilled)}</p>
        </div>
        <div className="bg-[#161b27] border border-[#21293d] rounded-2xl p-4 text-center">
          <p className="text-[10px] font-black uppercase text-slate-600 tracking-widest">
            Total Paid
            ...
            <thead>
              <tr className="bg-[#111520]">
                {["Supplier", "Total Billed", "Total Paid", "Outstanding", ""].map((h) => (
                  <th
                    key={h}
                    className="px-4 py-3 text-[10px] font-black uppercase text-slate-600 tracking-widest text-left"
                  >
                    {h}
                  </th>
                ))}
                  ...
                  .map((r) => (
                    ...
                    >
                      <td className="px-4 py-3">
                        ...
                        >
                          <Truck size={13} className="text-slate-600" /> {r.name}
                        </Link>
                      </td>
