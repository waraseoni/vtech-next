    ...
    <div className="space-y-6 max-w-[1600px] mx-auto pb-20">
      ...
      <div className="bg-[#161b27] border border-[#21293d] rounded-[2rem] p-5 no-print shadow-2xl flex flex-wrap items-end gap-6">
        <form onSubmit={handleFilter} className="flex flex-wrap items-end gap-6 flex-1">
          ...
          <button
            type="submit"
            className="px-10 py-3.5 bg-amber-600 hover:bg-amber-500 text-white rounded-2xl text-xs font-black uppercase tracking-[0.2em] transition-all shadow-xl shadow-amber-600/20"
          >
            Refresh Report
          </button>
        </form>
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-20 text-center text-slate-600 italic">
                    No pending jobs found for the selected criteria.
                  </td>
                </tr>
              ) : (
