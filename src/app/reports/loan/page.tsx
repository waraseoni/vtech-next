          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={9} className="text-center py-12 text-slate-600 text-xs font-bold">
                    No loan data found
                  </td>
                </tr>
              ) : (
                rows.map((r, i) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-xs text-center text-slate-400">
                      {r.interest_rate}%
                    </td>
            ...
            <tfoot>
              <tr className="border-t-2 border-blue-500/30 bg-blue-500/5">
                <td colSpan={2} className="px-3 py-3 text-xs font-black text-slate-400 text-right">
                  Total:
                </td>
                ...
                <td className="px-3 py-3 text-xs text-right font-black text-slate-300">
                  {inr(tTarget)}
                </td>
