      ...
      {items.map((it, i) => (
        ...
        >
          <div className="relative h-32 sm:h-36 overflow-hidden bg-[#080a18]">
            ...
            {it.badge && (
              <span
                className={`absolute top-3 right-3 z-10 text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-full border backdrop-blur-sm ${
                  it.badge === "available"
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
      {points.map((p, i) => (
        <div
          key={i}
          className="flex gap-3 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06]"
        >
            ...
            {[
              {
                ...
                title: "Bhejo & Diagnose",
                desc: "Equipment shop par lao ya photo bhejo — free diagnosis.",
              },
              {
                icon: <Wrench size={20} />,
              ...
              },
              {
                ...
                desc: "Full load test ke baad hi equipment return hota hai.",
              },
            ].map((f, i) => (
