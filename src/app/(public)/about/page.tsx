...
import { SITE, WHATSAPP_LINK, IS_BRANDED, getSiteInfo, type SiteInfo } from "../site";
...
function StatChip({ value, suffix, label }: { value: number; suffix: string; label: string }) {
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      (e) => e.forEach((x) => x.isIntersecting && setStarted(true)),
      { threshold: 0.4 }
    );
    io.observe(el);
      ...
      <section className="relative overflow-hidden border-b border-white/[0.06]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:py-20">
          ...
          <p className="mt-4 text-[14px] sm:text-base text-slate-400 leading-relaxed max-w-2xl">
            ...
            equipment repair aur maintenance ke liye bharosemand service milti hai — genuine parts
            aur fair pricing ke saath.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-3xl p-6 sm:p-8 bg-white/[0.03] border border-white/[0.08]">
            <h2 className="font-display text-xl sm:text-2xl font-black text-center mb-6">
              Contact Information
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a
                href={`tel:+${phone.replace(/\D/g, "")}`}
                className="flex items-start gap-3 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06] active:scale-[0.99] transition-transform"
              >
            ...
            <a
              href={WHATSAPP_LINK("", info.whatsapp)}
              target="_blank"
          ...
          <div className="relative overflow-hidden rounded-3xl p-7 sm:p-10 text-center bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-700">
            ...
            <div className="relative">
              <h3 className="font-display text-2xl sm:text-3xl font-black tracking-tight">
                Ready to Get Your Equipment Repaired?
              </h3>
              <p className="mt-2 text-[14px] text-blue-100/90">
                Aaj hi call karo — free diagnostic assessment.
              </p>
            ...
            <div>
              ...
              <div className="mt-5 space-y-4 text-[14px] sm:text-[15px] text-slate-400 leading-relaxed">
                <p>
                  ...
                  theek karne ka junoon.
                </p>
                <p>
                  Aaj hum proudly hain — Central India ka{" "}
                  <strong className="text-blue-400">largest aur most trusted</strong> repair center
                  for DJ systems, moving heads, laser lights, LED walls, processors aur SMPS.
                </p>
                <p>
                  Shaadi ki emergency 2 AM par ho ya kal ka bada event —{" "}
                  <strong className="text-blue-400">hum kabhi &quot;na&quot; nahi bolte</strong>.
                </p>
              </div>
              <div className="mt-5 rounded-2xl p-5 border-l-4 border-blue-500 bg-white/[0.03]">
                <p className="font-bold text-white text-[15px]">
                  &ldquo;Aapka bharosa hi hamari sabse badi kamai hai. Jab aapka equipment perfect
                  chalta hai aur aap smile karte ho — wahi hamara reward hai.&rdquo;
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-6 sm:p-8 bg-gradient-to-b from-white/[0.05] to-white/[0.02] border border-white/[0.08]">
              <div className="grid grid-cols-3 gap-4 text-center mb-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex flex-col items-center gap-2 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06]"
                  >
                    {s.icon}
            ...
            {[
              {
                ...
                desc: "90% jobs 24 ghante mein. Emergency? 2–6 ghante mein fix!",
              },
              {
                icon: <Trophy size={20} />,
                title: "17 Years of Mastery",
                desc: "Basic SMPS se lekar high-end LED wall processor tak — sab dekha hai.",
              },
              {
                icon: <ShieldCheck size={20} />,
                title: "100% Transparent",
                desc: "Original parts. Koi hidden charges nahi. Sab kuch dikhta hai.",
              },
            ].map((f, i) => (
              <div
                key={i}
                className="rounded-3xl p-6 bg-white/[0.03] border border-white/[0.06] hover:border-blue-500/40 transition-all"
              >
            ...
            {[
              {
                ...
                quote:
                  "Har kharab equipment ki ek kahani hoti hai. Main bas use dobara chalana seekhata hoon.",
              },
              {
                name: "Preeti Jain",
                role: "Customer Happiness Manager",
                quote: "Repair item uthate waqt aapki smile — wahi mera sabse bada reward hai.",
              },
              {
                name: "Hemant Mehra",
                role: "Head Technician",
                quote:
                  "Dead circuit se perfect beats tak — main machines ko wapas zinda karta hoon.",
              },
            ].map((m, i) => (
              <div
                key={i}
                className="rounded-3xl overflow-hidden bg-white/[0.03] border border-white/[0.06] hover:border-blue-500/40 transition-all"
              >
      ...
      <section className="py-12 sm:py-16 bg-[#0a0a18]/60 border-y border-white/[0.05]">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              {
                q: "2 AM pe DJ kharab ho gaya tha — Vikram bhai 3 ghante mein fix kar ke de gaye. Life saver!",
                n: "Rohit DJ, Jabalpur",
              },
              {
                q: "LED wall ka processor jal gaya tha — market mein 15 din bol rahe the. Yahan 18 ghante mein ho gaya!",
                n: "Shubham Events",
              },
            ].map((t, i) => (
