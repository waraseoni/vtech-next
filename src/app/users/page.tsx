      ...
      <div className="max-w-4xl mx-auto px-4 pt-6 space-y-4">
        ...
        <div className="bg-[#111520] border border-[#21293d] rounded-xl px-4 py-3">
          ...
          <p className="text-xs text-slate-700 leading-relaxed">
            Supabase → Table Editor → <code className="text-slate-500">profiles</code> table mein
            check karo ki rows hain ya nahi। Agar nahi hain to pehle{" "}
            <strong className="text-slate-500">Create New</strong> se user banao। Ya{" "}
            <code className="text-slate-500">SUPABASE_SERVICE_ROLE_KEY</code> .env.local mein check
            karo।
          </p>
        </div>
      </div>
          ...
          <div className="bg-[#161b27] border border-[#21293d] rounded-2xl shadow-2xl w-full max-w-sm p-5">
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-slate-500">
                <strong className="text-slate-300">{deleteUser.full_name}</strong> ko permanently
