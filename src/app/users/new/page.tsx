            ...
            <div>
              ...
              {password && (
                <div className="flex items-center gap-2 mt-1.5">
                  <div
                    className={`h-1 flex-1 rounded-full ${password.length >= 8 ? "bg-emerald-500" : password.length >= 6 ? "bg-amber-500" : "bg-red-500"}`}
                  />
                  <span
                    className={`text-[10px] font-bold ${password.length >= 8 ? "text-emerald-400" : password.length >= 6 ? "text-amber-400" : "text-red-400"}`}
                  >
