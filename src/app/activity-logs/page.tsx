...
export default function ActivityLogsPage() {
  ...
  const getModuleIcon = (mod: string) => {
    switch (mod) {
      ...
      default:
        return <Info size={12} className="text-slate-500" />;
    }
  };
        ...
        <div className="bg-[#161b27] border border-[#21293d] rounded-2xl p-5">
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex-1 min-w-[240px]">
              <label className="block text-[10px] font-black uppercase tracking-widest text-slate-600 mb-1.5 ml-1">
                Search Logs
              </label>
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="bg-[#0d1117]/50 border-b border-[#21293d]">
                      <th className="text-left px-5 py-4 text-[10px] font-black uppercase tracking-widest text-slate-600">
                        Time
                      </th>
                      <th className="text-left px-5 py-4 text-[10px] font-black uppercase tracking-widest text-slate-600">
                        User
              ...
              <div className="md:hidden divide-y divide-[#21293d]">
                {logs.map((log) => (
                  <div key={log.id} className="p-4 hover:bg-white/[0.02] transition-colors group">
                    ...
                    <div className="mt-3">
                      <span className="text-slate-300 font-bold text-sm block mb-1">
                        {log.action}
                      </span>
