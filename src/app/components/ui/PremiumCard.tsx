...
export const PremiumCard: React.FC<PremiumCardProps> = ({
  ...
  return (
    <div className={`group relative h-full ${className}`}>
      ...
      {glow && (
        <div
          className={`absolute -inset-1 bg-gradient-to-br ${glowColors[glowColor]} transition-all duration-500 opacity-0 group-hover:opacity-10 dark:group-hover:opacity-20 rounded-[2rem] blur-lg`}
        ></div>
      )}
