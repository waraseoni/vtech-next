      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
        <div className="flex items-center gap-6">
          <div className="relative group">
            ...
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-white dark:bg-panel border border-app-2 dark:border-white/10 flex items-center justify-center shadow-xl dark:shadow-2xl relative z-10 transform group-hover:rotate-12 transition-transform duration-500">
              <Icon size={32} className="text-blue-600 dark:text-blue-400" />
            </div>
          </div>
          <div>
            <h1 className="text-3xl md:text-4xl font-black text-app dark:text-white tracking-tight flex items-center gap-4">
              {title}
            ...
            {subtitle && (
              <p className="text-muted dark:text-muted text-[10px] font-black uppercase tracking-[0.3em] mt-2">
                {subtitle}
              </p>
            )}
          </div>
