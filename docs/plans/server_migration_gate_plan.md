...
| **G2** | Baseline metrics captured | ❌ NO | Koi Web-Vitals/TTI baseline kisi key page par nahi liya. Safe-yes = dashboard, clients, jobs, cash-flow, monthly-profit ke TTI/FCP recorded ek stable state me. |
