...
| # | Item | Effort |
|---|---|---|
| 6 | `DataTable` (desktop table + mobile cards + sort/page) + pilot on 3 pages | 4 | ✅ **Component done** (`src/components/ui/DataTable.tsx`). Suppliers ✅ + direct-sales ✅ pilots done. Pending: payments pilot. |
