            ...
            <div class="container-fluid" id="print_out">
                ...
                <div class="text-center mb-5 position-relative">
                    <div class="d-flex justify-content-center align-items-center mb-3 flex-column flex-md-row">
                        <div class="company-logo-placeholder rounded-circle bg-primary d-flex align-items-center justify-content-center me-0 me-md-3 mb-3 mb-md-0" style="width: 60px; height: 60px;">
                            <span class="text-white fs-4 fw-bold">V-Tech</span>
                        </div>
                        <div>
                            <h2 class="fw-bold mb-1 text-primary">V-Technologies</h2>
                            <p class="mb-0 text-muted">F4, Hotel Plaza, Marhatal, Jabalpur</p>
                            <p class="mb-0 text-muted"><i class="fas fa-phone me-1"></i> 9179105875 </p>
                        </div>
                    </div>
                ...
                <div class="mt-5 pt-4 border-top text-center">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <p class="mb-1"><strong>V-Technologies Stamp</strong></p>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-muted mb-0">
                            <i class="fas fa-phone me-1"></i> For queries, contact: 9179105875
                        </p>
