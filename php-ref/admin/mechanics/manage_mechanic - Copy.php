    ...
    <form action="" id="mechanic-form" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                <!--    <div class="form-group col-md-6">
                        <label for="date_joined" class="control-label">Joining Date</label>
                        <input type="date" name="date_joined" id="date_joined" class="form-control" value="<?php echo isset($date_joined) ? date("Y-m-d", strtotime($date_joined)) : date("Y-m-d") ?>" required>
                    </div> -->
                    <div class="form-group col-md-6">
