...
// ====================================================================
// FINAL CORRECTED QUERY (Based on vtech_test.sql Schema)
// ====================================================================
$query_string = "
    ...
    -- 2. Direct Sales (NEW) [Table: direct_sales]
    ...
    -- Correct Columns: category, remarks (No reason/expense_name column)
    ...
    -- Correct Column: reason (Ye column is table me hai)
    ...
    ORDER BY date DESC, details ASC";
